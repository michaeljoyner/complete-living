...
<div class="max-w-lg mx-auto py-12 md:py-20">
    ...
    <p class="mt-3"><span class="font-serif">Email: </span><a href="mailto:stephjoyner18@gmail.com" class="no-underline hover:text-pink-dark text-black">stephjoyner18@gmail.com</a></p>
</div>
