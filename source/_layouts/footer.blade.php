<footer>
    <div class="max-w-xl mx-auto mt-20">
        <div class="h-2 border-t border-b border-grey"></div>
        <div class="flex flex-col md:flex-row justify-between font-serif leading-normal py-8 md:px-12">
            <div class="mb-4 text-center md:text-left">
                <p>Stephanie Joyner, MSc (Diet)</p>
                <p>HPCSA member: DT 0038318</p>
